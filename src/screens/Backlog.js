...
const Backlog = () => {
  const { tasks, selectedProject } = useContext(TasksContext)
  ...
  return (
    <div className='col-[2_/_-1] row-span-full flex flex-col'>
      ...
      <div className="h-full overflow-hidden flex flex-col">
        <p className="uppercase text-center font-medium text-xl mb-1">backlog</p>
        <p className="uppercase text-center font-medium text-2xl mb-1">{selectedProject}</p>
        ...
        <div className="grid grid-cols-4 px-6 gap-6 2xl:gap-10 2xl:px-14 grow-0 basis-5/6 overflow-y-auto">
